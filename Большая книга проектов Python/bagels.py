...
Дедуктиваная логическая игра на угадываение числа по подсказкам.
...
clue would be Fermi Pico.'''format(NUM_DIGITS))
    ...
    while True:  # Основной цикл игры.
        # Переменная, в которой хранятся секретное число, которое
